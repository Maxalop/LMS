...
(Manager_ID int PRIMARY KEY,Manager_Name VARCHAR(30) NOT NULL, 
 Job VARCHAR(30) NOT NULL,Boss_Code int,Salary int NOT NULL, 
 Commission int,DEPARTMENT_ID int); 
 
 CREATE TABLE PMS_UNIT_DETAILS 
(UNIT_ID VARCHAR(2) PRIMARY KEY,UNIT_NAME VARCHAR(30) NOT NULL, 
 PIECE_WEIGHT VARCHAR(15) NOT NULL,TOTAL_PIECES int NOT NULL, 
...
(MANFATURE_ID VARCHAR(5) PRIMARY KEY,PRODUCT_ID VARCHAR(5) NOT NULL, 
 UNIT_ID VARCHAR(5) NOT NULL,QUANTITY int NOT NULL,AVAILABILITY VARCHAR(3) NOT NULL, 
PRODUCT_MANFACTURE_DATE DATE NOT NULL,PRODUCT_EXPIRY_DATE DATE NOT NULL); 

ALTER table PMS_MANUFACTURING 
	MODIFY PRODUCT_MANFACTURE_DATE varchar(10);
ALTER table PMS_MANUFACTURING 
	MODIFY PRODUCT_EXPIRY_DATE varchar(10);
...
select date_format(str_to_date('10-Aug-12', '%d-%mm-%y'), '%Y-%m') as MyGFDate; 

select str_to_date(, '%d-%m-%Y') as Axe;

SELECT FORMAT(GETDATE(), 'D', 'en-gb');

 select DATE('2012-08-15') AS TreatDate ;
 select DATE('10-Aug-12') AS DoubleTreatDate;
 select casT(DATEPART(Year,now())  as varchar(4)) AS DoubleTreatDate
 
 select DATEPART(Year,now())
 
 select DATE_FORMAT(now(),'%d-%b-%Y') as TripleTreatDate
 
 '10-Aug-12'
 
 select dateformat(str_to_date
 
 SELECT date_format(STR_TO_DATE('10-Aug-12','%d-%b-%Y'),'%d/%b/%Y') as FourTreatDate;
...
INSERT INTO PMS_MANUFACTURING VALUES('M001','P001','C2',100,'YES','15-Aug-12','15-Dec-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M002','P001','P2',500,'YES','10-Aug-12','15-Dec-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M003','P001','P3',250,'YES','10-Aug-12','15-Dec-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M004','P001','P1',300,'NO','15-Aug-12','15-Dec-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M005','P002','C1',190,'YES','5-Aug-12','31-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M006','P002','P1',500,'YES','5-Aug-12','31-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M007','P002','P2',250,'YES','5-Aug-12','31-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M008','P002','P3',500,'YES','5-Aug-12','31-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M009','P006','P1',4500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M010','P006','P2',7500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M011','P006','P3',10000,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M012','P007','P1',4000,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M013','P007','P2',3000,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M014','P007','P3',2500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M015','P008','P1',7000,'NO','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M016','P008','P2',3500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M017','P008','P3',4500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M018','P009','P1',1500,'NO','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M019','P009','P2',2500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M020','P009','P3',1000,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M021','P010','P1',10000,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M022','P010','P2',25000,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M023','P010','P3',12500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M024','P003','P2',2400,'YES','10-Aug-12','10-Oct-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M025','P003','P3',3210,'NO','10-Aug-12','10-Oct-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M026','P004','T1',750,'YES','10-Aug-12','10-Dec-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M027','P005','P3',10000,'YES','15-Aug-12','17-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M028','P011','P3',27500,'YES','15-Aug-12','16-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M029','P012','M1',2750,'YES','15-Aug-12','31-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M030','P012','M2',1850,'NO','15-Aug-12','31-Aug-12'); 
INSERT INTO PMS_MANUFACTURING VALUES('M031','P013','C1',1300,'YES','10-Aug-12','11-Aug-12'); 
